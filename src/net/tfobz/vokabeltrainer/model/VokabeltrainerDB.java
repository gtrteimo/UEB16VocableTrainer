...
//	}
	...
	public static void mainn(String[] args) {
		...
		// Holt sich alle Fï¿½cher dieser Lernkartei
	...
	public static Connection getConnection() throws SQLException {
		Connection ret = null;
		try {
			// Registrieren des JDBC-Treibers fï¿½r HSQLDB
		...
		// wird ein SHUTDOWN durchgefï¿½hrt, welches Datenï¿½nderungen in
		// .script-Datei schreibt
		p.setProperty("shutdown", "true");
		// Datenbank wird angelegt falls nicht vorhanden
		// ï¿½ffnen der Datenbankverbindung. "file" bedeutet dass die Datenbank
		// aus Memory-Tabellen besteht. "mem" wï¿½rde ausschlieï¿½lich Temp-Tabellen
		// anlegen
	...
	/**
	 * Holt die Lernkartei welche die ï¿½bergebene Nummer hat aus der Datenbank
	 * @param nummer
	...
	/**
	 * Liefert zur Ã¼bergebenen Lernkartei die Fï¿½cher
	 * @return null falls die Lernkartei nicht existiert oder Datenbankfehler
	 * aufgetreten ist<br>
	 * eine leere ArrayList wenn keine Fï¿½cher zur Lernkartei existieren
	 */
	...
	/**
	 * Sucht das Fach mit der ï¿½bergebenen Nummer. Dabei muss das Fach zur
	 * Lernkartei mit der ï¿½bergebenen Nummer gehï¿½ren
	...
	/**
	 * Sucht das Fach mit der ï¿½bergebenen Nummer
	 * @param nummerFach
  ...
  public static Fach getFach(int nummerFach) {
	...
	/**
	 * Liefert eine zufï¿½llige Karte aus dem ï¿½bergebenen Fach der ï¿½bergebenen Lernkartei. Es wird 
	...
	/**
	 * Liefert die Karte mit der ï¿½bergebenen Nummer
	 * @param nummerKarte
	...
	/**
	 * Fï¿½gt neues Fach zur aktuellen Lernkartei am Ende hinzu. Im Fach wird die Nummer gesetzt,
	 * welche vom Datenbanksystem vergeben wird. Im Fach wird gelerntAm auf das heutige
	 * Datum gesetzt falls im ï¿½bergebenen Objekt gelerntAm nicht gesetzt wurde. Wurde die 
	...
	/**
	 * ï¿½ndert die Inhalte eines bestehenden Faches. Dabei kï¿½nnen nur die Beschreibung,
	 * die Erinnerung und gelerntAm geï¿½ndert werden
	 * @param fach
	...
	/**
	 * Fï¿½gt neue Lernkartei in die Datenbank ein. Die Lernkartei erhï¿½lt die Nummer,
	...
	/**
	 * ï¿½ndert eine bestehende Lernkartei in der Datenbank
	 * @param lernkartei
	 ...
	 * Beschreibung schon existiert. Im letzteren Fall wird fï¿½r die Beschreibung eine
	 * entsprechende Fehlermeldung gesetzt
	 */
	...
	/**
	 * Lï¿½scht die ï¿½bergebene Lernkartei aus der Datenbank. Dabei werden
	 * auch alle Fï¿½cher und Karten die zu dieser Lernkartei gehï¿½ren mit
	 * gelï¿½scht
	 * @param nummerLernkartei
	...
	/**
	 * Fï¿½gt eine neue Karte in das erste Fach der ï¿½bergebenen Lernkartei ein. Die
	 * Karte erhï¿½lt beim Einfï¿½gen die Nummer welche diese in der Datenbank hat
	 * @param nummerLernkartei
	 * @param karte
	 * @return -1 wenn Datenbankfehler aufgetreten ist<br>
	 * -2 falls Karte nicht vollstï¿½ndig ist<br>
	...
	/**
   * ï¿½ndert von einer bestehenden Karte die Wï¿½rter. Andere Eigenschaften der
	 * Karte kï¿½nnen nicht geï¿½ndert werden. Die Karte verbleibt in demselben Fach
	 * @param nummerLernkartei
	 * @param karte
 ...
 /**
	 * Lï¿½scht die Karte mit der ï¿½bergebenen Nummer aus der Datenbank
	 * @param nummerKarte
	...
	/**
	 * Lï¿½scht aus ï¿½bergebenen Lernkartei alle Fï¿½cher und somit
	 * alle Karten die den Fï¿½chern zugeordnet sind
	...
	/**
	 * Liefert eine Liste aller Lernkarteien in denen Fï¿½cher existieren deren
	 * Erinnerung abgelaufen ist. Eine Erinnerung lï¿½uft ab, wenn die Differenz zwischen
	 * dem heutigen Datum und dem Datum an dem zuletzt gelernt wurde grï¿½ï¿½er oder gleich der
	 * Erinnerung ist. Auch werden alle Lernkarteien zurï¿½ck geliefert
	 * die Fï¿½cher enthalten in denen noch nie gelernt wurde. Ist das Erinnerungsintervall 0 so
	 * werden die Fï¿½cher nicht berï¿½cksichtigt
	 * @return null falls ein Datenbankfehler aufgetreten ist<br>
	 * eine leere ArrayList falls keine Lernkarteien zu finden sind
	 */
 ...
 /**
	 * Liefert zur ï¿½bergebenen Lernkartei die Fï¿½cher bei denen die Erinnerung abgelaufen 
	 * ist
	 * @return null falls Lernkartei nicht existiert oder Datenbankfehler aufgetreten 
	 * ist<br>
	 * eine leere ArrayList wenn keine Fï¿½cher zur Lernkartei existieren bei denen die
	...
	/**
	 * Holt die Karten des ï¿½bergebenen Faches
	 * @param nummerFach
	...
	/**
	 * Importiert Karten in die Lernkartei deren Nummer ï¿½bergeben wird. Sollte diese
	 * schon Fï¿½cher und Karten haben, so werden diese vorher gelï¿½scht.
	 * Tritt beim Importieren ein Fehler auf, so wird das Lï¿½schen rï¿½ckgï¿½ngig
	 * gemacht.<br>
	 * Die unterstï¿½tzten Formate fï¿½r den Import sind:<br>
	 * Haus; house<br>
	 * Strauch; shrub<br>
	 * Zaun; fence<br>
	 * Garten; Garden<br>
	 ...
	 * Hier gibt die dritte Spalte die Zugehï¿½rigkeit zu den Fï¿½chern wieder, welche
	    ...
	    if (pfad != null && pfad.length() > 0) {
	        ...
	        try {
	            ...
	            while (true) {
	                ...
	                if (!geloescht) {
	                    geloescht = true;
	                    System.out.println("Deleting existing Fächer for Lernkartei: " + nummerLernkartei);
	...
	/**
	 * Exportiert alle Karten der ï¿½bergebenen Lernkartei in eine Textdatei mit oder ohne Fï¿½cher.
	 * Dabei wird die Fachnummer am Ende jeder Zeile hinzugefï¿½gt
	 * @param nummerLernkartei
	 * @param pfad
	 * @param mitFaechern
  ...
  public static int exportierenKarten(int nummerLernkartei, String pfad, boolean mitFaechern) {
	...
	/**
	 * Setzt die ï¿½bergebene Lernkartei als Standardlernkartei, welche beim
	 * ï¿½ffnen verwendet wird. Wird der Methode -1 ï¿½bergeben, so wird der Eintrag
	 * fï¿½r Standardlernkartei gelï¿½scht
	 * @param nummerLernkartei
	...
	/**
	 * Legt fest, dass Benutzer nur in Lernkarteien mit Erinnerung lernen mï¿½chte
	...
	/**
	 * Liefert zurï¿½ck ob der Benutzer nur in Lernkarteien mit abgelaufener Erinnerung
	 * lernen mï¿½chte
	...
	public static List<Karte> getKartenUndBoxenVonLernkartei(int nummerLernkartei) {
	    ...
	    try {
	        ...
	        while (rs.next()) {
	            ...
	            System.out.println("  Groß-/Kleinschreibung: " + grossKleinschreibung);
